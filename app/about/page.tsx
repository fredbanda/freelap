        ...
        <div className="lg:max-w-lg">
          ...
          <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            ...
            <div className="relative pl-9">
              ...
              <dd className="inline"> From the beginning of time Africans have always believed that it takes the whole village to raise a child. Ubuntu which practiced in the entire of Africa believes in giving back to the community.
                .</dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
